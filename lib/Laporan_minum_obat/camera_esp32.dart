...
class camera_esp32 extends StatefulWidget {
  const camera_esp32({Key? key, this.cookieManager}) : super(key: key);

  final CookieManager? cookieManager;

  @override
  State<camera_esp32> createState() => _camera_esp32State();
}

class _camera_esp32State extends State<camera_esp32> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        initialUrl: 'http://192.168.253.124',
